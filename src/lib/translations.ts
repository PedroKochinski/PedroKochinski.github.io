...
type Dictionary = {
  ...
  services: {
    ...
    title: string;
    subtitle: string;
    items: { t: string; d: string; bullets: string[] }[];
  };
  proof: { eyebrow: string; title: string; subtitle: string; items: { k: string; v: string }[] };
  cases: {
    eyebrow: string;
    title: string;
    items: { tag: string; t: string; problem: string; solution: string; result: string }[];
  };
  clients: {
    eyebrow: string;
    title: string;
    subtitle: string;
    items: { name: string; location: string; role: string; scope: string; tags: string[] }[];
  };
  tech: {
    eyebrow: string;
    title: string;
  ...
  packages: {
    eyebrow: string;
    title: string;
    items: { t: string; who: string; deliverables: string[]; featured?: boolean }[];
  };
  ...
  en: {
    ...
    hero: {
      ...
      stats: [
        {
          k: "ETL Pipelines",
          v: "experience handling massive customer datasets for recommendation systems",
        },
    ...
    problems: {
      ...
      items: [
        {
          t: "Robust APIs for digital products",
          d: "REST, FastAPI, auth, queues and workers — designed to scale and to be operated.",
        },
        {
          t: "AI integrated into existing systems",
          d: "Not a side experiment. LLMs wired into your backend, your data and your workflows.",
        },
        {
          t: "Internal assistants and corporate chatbots",
          d: "Conversational layers over Git, SQL, documents and operational knowledge.",
        },
        {
          t: "Smart search across documents and data",
          d: "Hybrid search, sparse + dense embeddings and reranking that actually returns relevant results.",
        },
        {
          t: "Recommendation systems",
          d: "Products, customers, content or companies — using vector search, filters and metadata boosting.",
        },
        {
          t: "Data shaped for AI",
          d: "Chunking, indexing, ETL pipelines and metadata strategy for structured and unstructured sources.",
        },
        {
          t: "From prototype to production",
          d: "Take a notebook or PoC and turn it into a deployed, monitored, evolvable system.",
        },
        {
          t: "Architecture, deploy and scalability",
          d: "Design or review of architecture, dockerization, server deploy and capacity planning.",
        },
      ],
    },
    services: {
      ...
      items: [
        {
          ...
          bullets: [
            "REST APIs · FastAPI · Node when needed",
            "Auth, queues, workers, microservices",
            "Database integration & data modeling",
            "Dockerization, deploy & technical docs",
          ],
        },
        {
          t: "Applied AI & LLMs",
          ...
          bullets: [
            "Corporate chatbots & internal assistants",
            "RAG over documents, SQL and internal bases",
            "OpenAI and other model providers",
            "Agentic workflows & AI endpoints",
          ],
        },
        {
        ...
        },
        {
          ...
          bullets: [
            ...
            "Technical planning for MVPs",
            "Deploy on servers and infra",
    ...
    proof: {
      ...
      items: [
        {
          k: "ETL Pipelines",
          v: "hands-on experience processing massive customer datasets for vector recommendation pipelines",
        },
      ...
      items: [
        {
          ...
          problem:
            "Need to recommend customers, products and companies based on structured and unstructured signals.",
          solution:
            "Embeddings, vector search, metadata boosting, filters and reranking on a multi-million record base.",
        ...
        },
        {
          ...
          problem:
            "Knowledge spread across documents, databases and tools — slow and unreliable to access.",
          solution:
            "Chunking & indexing strategy, hybrid retrieval (sparse + dense + RRF) wired into an LLM.",
        ...
        },
        {
          ...
          problem:
            "Support team needed faster access to logs, internal bases and operational knowledge.",
          solution:
            "Agentic workflows with RAG, PostgreSQL and Cassandra integration, Docker, LangChain, LangGraph and OpenAI.",
    ...
    clients: {
      ...
      items: [
        ...
        },
        {
          ...
          scope:
            "Recommendation algorithms, ETL pipelines, RAG systems and AI-powered application development to support business intelligence and end-user products.",
        ...
        },
        {
          ...
          role: "AI & Backend Engineering",
          scope:
            "Chatbots, REST APIs and SaaS development — from architecture to delivery of production-grade product features.",
    ...
    tech: {
      ...
      groups: [
        ...
        {
          t: "AI & LLMs",
          items: ["RAG", "Embeddings", "LangChain", "LangGraph", "OpenAI", "Agents"],
        },
        {
          t: "Data & Search",
          items: [
    ...
    process: {
      ...
      steps: [
        {
          n: "01",
          t: "Technical diagnosis",
          d: "Understand the problem, the data and the existing systems before proposing anything.",
        },
        {
          n: "02",
          t: "Solution design",
          d: "Architecture, scope, trade-offs and a clear delivery plan.",
        },
        {
          n: "03",
          t: "Implementation",
          d: "Build in iterations with working software at every step.",
        },
        { n: "04", t: "Deploy", d: "Dockerization, server deploy and operational handover." },
        {
          n: "05",
          t: "Evolution & support",
          d: "Monitor, refine and grow the system after go-live.",
        },
      ],
    },
    packages: {
      ...
      items: [
        {
          t: "AI & Architecture Diagnostic",
          who: "For teams unsure where to start with AI or how to fix a stuck architecture.",
          deliverables: ["Technical audit", "Architecture review", "Roadmap & recommendations"],
        },
        {
          t: "AI / API / Automation MVP",
          who: "For companies validating an AI, API or automation product.",
          deliverables: ["Architecture & build", "Working MVP", "Deploy & documentation"],
          featured: true,
        },
        {
          t: "Production System",
          who: "For products that need to scale beyond the MVP.",
          deliverables: [
        ...
        {
          t: "Monthly Consultancy",
          who: "For tech teams that need ongoing senior support.",
          deliverables: ["Architecture guidance", "Code & PR review", "Hands-on contribution"],
        },
      ],
    },
    about: {
  ...
  pt: {
    ...
    hero: {
      ...
      stats: [
        {
          k: "Pipelines ETL",
          v: "experiência tratando grandes volumes de dados de clientes para sistemas de recomendação",
        },
    ...
    problems: {
      ...
      items: [
        {
          t: "APIs robustas para produtos digitais",
          d: "REST, FastAPI, autenticação, filas e workers — pensados para escalar e serem operados.",
        },
        {
          t: "IA integrada a sistemas existentes",
          d: "Não é experimento isolado. LLMs conectadas ao seu backend, seus dados e seus fluxos.",
        },
        {
          t: "Assistentes internos e chatbots corporativos",
          d: "Camadas conversacionais sobre Git, SQL, documentos e conhecimento operacional.",
        },
        {
          t: "Busca inteligente em documentos e dados",
          d: "Hybrid search, embeddings sparse + dense e reranking que devolve resultados relevantes.",
        },
        {
          t: "Sistemas de recomendação",
          d: "Produtos, clientes, conteúdos ou empresas — com vector search, filtros e metadata boosting.",
        },
        {
          t: "Dados organizados para uso com IA",
          d: "Chunking, indexação, pipelines ETL e estratégia de metadados para fontes estruturadas e não.",
        },
        {
          t: "Do protótipo à produção",
          d: "Pegar notebook ou PoC e transformar em sistema deployado, monitorado e evolutivo.",
        },
        {
          t: "Arquitetura, deploy e escalabilidade",
          d: "Desenho ou revisão de arquitetura, dockerização, deploy em servidor e planejamento de capacidade.",
        },
      ],
    },
    services: {
      ...
      items: [
        {
          ...
          bullets: [
            "APIs REST · FastAPI · Node quando faz sentido",
            "Auth, filas, workers, microserviços",
            "Integração com banco e modelagem de dados",
            "Dockerização, deploy e documentação técnica",
          ],
        },
        {
          ...
          bullets: [
            ...
            "RAG sobre documentos, SQL e bases internas",
            "OpenAI e outros provedores de modelos",
            "Workflows agentic e endpoints com IA",
          ],
        },
        {
          ...
          bullets: [
            ...
            "Hybrid search · RRF · reranking",
            "Metadata boosting e filtragem",
            "Avaliação e melhoria de relevância",
          ],
        },
        {
          ...
          bullets: [
            "Desenho e revisão de arquitetura",
            "Planejamento técnico para MVPs",
            "Deploy em servidores e infra",
    ...
    proof: {
      ...
      items: [
        {
          k: "Pipelines ETL",
          v: "experiência hands-on processando grandes volumes de dados de clientes em pipelines de recomendação vetorial",
        },
      ...
      items: [
        {
          ...
          problem:
            "Necessidade de recomendar clientes, produtos e empresas a partir de sinais estruturados e não estruturados.",
          solution:
            "Embeddings, vector search, metadata boosting, filtros e reranking em base com milhões de registros.",
        ...
        },
        {
          ...
          problem:
            "Conhecimento espalhado em documentos, bancos e ferramentas — acesso lento e pouco confiável.",
          solution:
            "Estratégia de chunking e indexação, retrieval híbrido (sparse + dense + RRF) integrado a uma LLM.",
        ...
        },
        {
          ...
          problem:
            "Time de suporte precisava acessar logs, bases internas e conhecimento operacional com mais velocidade.",
          solution:
            "Workflows agentic com RAG, integração PostgreSQL e Cassandra, Docker, LangChain, LangGraph e OpenAI.",
    ...
    clients: {
      ...
      items: [
        ...
        },
        {
          ...
          scope:
            "Algoritmos de recomendação, pipelines ETL, sistemas RAG e desenvolvimento de aplicações com IA para apoiar inteligência de negócio e produtos para usuários finais.",
        ...
        },
        {
          ...
          role: "Engenharia de IA e Backend",
          scope:
            "Chatbots, APIs REST e desenvolvimento de SaaS — da arquitetura à entrega de funcionalidades de produto em produção.",
          tags: ["Chatbots", "APIs", "SaaS"],
        },
      ],
    },
    tech: {
      ...
      groups: [
        ...
        {
          t: "IA e LLMs",
          items: ["RAG", "Embeddings", "LangChain", "LangGraph", "OpenAI", "Agentes"],
        },
        {
          t: "Dados e Busca",
          items: [
      ...
      steps: [
        {
          ...
          d: "Entender o problema, os dados e os sistemas existentes antes de propor qualquer coisa.",
        },
        {
          n: "02",
          t: "Desenho da solução",
          d: "Arquitetura, escopo, trade-offs e um plano de entrega claro.",
        },
        {
          n: "03",
          t: "Implementação",
          d: "Construção em iterações, com software funcionando a cada passo.",
        },
        { n: "04", t: "Deploy", d: "Dockerização, deploy em servidor e handover operacional." },
        {
          n: "05",
          t: "Evolução e suporte",
          d: "Monitorar, refinar e evoluir o sistema depois do go-live.",
        },
      ],
    },
    packages: {
      ...
      items: [
        {
          t: "Diagnóstico de IA e Arquitetura",
          who: "Para times sem clareza de por onde começar com IA ou como destravar uma arquitetura.",
          deliverables: ["Auditoria técnica", "Revisão de arquitetura", "Roadmap e recomendações"],
        },
        {
          t: "MVP de IA, API ou Automação",
          who: "Para empresas validando um produto com IA, API ou automação.",
          deliverables: ["Arquitetura e construção", "MVP funcionando", "Deploy e documentação"],
          featured: true,
        },
        {
          t: "Sistema em Produção",
          who: "Para produtos que precisam escalar além do MVP.",
          deliverables: [
            "Backend production-grade",
            "Integração de IA/Busca",
            "Infra, deploy e monitoramento",
          ],
        },
        {
          t: "Consultoria Mensal",
          who: "Para times técnicos que precisam de apoio sênior contínuo.",
          deliverables: [
            "Direção arquitetural",
            "Revisão de código e PRs",
            "Contribuição hands-on",
          ],
        },
      ],
    },
